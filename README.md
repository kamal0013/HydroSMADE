...
4. Run the cells to read HydroSMADE data and estimate the basin-level annual hydropower availability for each scenario.
5. Plot the trajectories of basin-level annual hydropower availability.
